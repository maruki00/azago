...
var GetHttpStatus = func(status int){
	switch(status){
	// Informational
	...
	case StatusNonAuthoritativeInfo: return  "Non-Authoritative Information"
	...
	case StatusProxyAuthRequired:            return  "Proxy Authentication Required"
	...
	case StatusTeapot:                       return  "I'm a teapot"
	...
	case StatusVariantAlsoNegotiates:          return  "Variant Also Negotiates"
